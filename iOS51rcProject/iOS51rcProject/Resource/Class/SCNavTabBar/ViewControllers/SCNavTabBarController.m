...
- (void)viewInit
{
    ...
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE, SCREEN_WIDTH, SCNAV_BAR_HEIGHT)];
    _navTabBar.delegate = self;
    _navTabBar.itemTitles = _titles;
    _navTabBar.isCompany = self.isCompany;
    [_navTabBar updateData];
    float heightForMainView = SCREEN_HEIGHT - _navTabBar.frame.origin.y - _navTabBar.frame.size.height - STATUS_BAR_HEIGHT - SCNAV_BAR_HEIGHT;
    if (_customHeight > 0) {
