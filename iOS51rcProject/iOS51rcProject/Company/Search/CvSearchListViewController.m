...
@interface CvSearchListViewController ()<UITableViewDelegate, UITableViewDataSource, NetWebServiceRequestDelegate>
...
@implementation CvSearchListViewController
...
- (void)getData {
    ...
    NetWebServiceRequest *request = [NetWebServiceRequest serviceRequestUrlCp:@"GetCpCvSearchList" Params:self.dataCondition viewController:self];
    [request setTag:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell fillCvInfo:[NSString stringWithFormat:@"期望月薪%@%@", [data objectForKey:@"dcSalaryName"], ([[data objectForKey:@"College"] length] > 0 ? [NSString stringWithFormat:@" | 毕业于%@", [data objectForKey:@"College"]] : @"")] gender:[data objectForKey:@"Gender"] name:[data objectForKey:@"JobName"] relatedWorkYears:[data objectForKey:@"RelatedWorkYears"] age:[data objectForKey:@"Age"] degree:[data objectForKey:@"DegreeName"] livePlace:[data objectForKey:@"LivePlaceName"] loginDate:[data objectForKey:@"LastLoginDate"] mobileVerifyDate:[data objectForKey:@"MobileVerifyDate"] paPhoto:@"" online:[data objectForKey:@"IsOnline"] paMainId:[data objectForKey:@"paMainId"] cvMainId:[data objectForKey:@"ID"]];
    return cell;
}
